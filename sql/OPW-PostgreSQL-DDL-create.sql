...
CREATE TABLE opw.opw_link (id  SERIAL NOT NULL, active BOOLEAN, comment VARCHAR(256), dateCreated VARCHAR(64), label VARCHAR(128), url VARCHAR(256), opw_wynik_id INTEGER NOT NULL, PRIMARY KEY (id))
